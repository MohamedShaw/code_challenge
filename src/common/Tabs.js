...
class Tabs extends Component {
  ...
  renderPage = (page, index) => (
    <NativeView
      ...
      style={[
        ...
        this.props.scrollable ? this.props.rtl && styles.rtl : null,
    ...
    >
      {React.cloneElement(page, {
        ...
        activePage: this.state.activePage,
        scrollAnimation: this.props.tabBarScrollValue,
        index,
      })}
    </NativeView>
  );
  ...
  renderScrollableContentIOS = () => {
    const { children, rtl, tabBarScrollValue, stickyHeader } = this.props;
      ...
      <AnimatedScrollView
        ...
        onScroll={Animated.event(
          [
            {
              nativeEvent: {
                contentOffset: { x: this.state.scrollXIOS, y: this.scrollY },
              },
            },
          ],
  ...
  render() {
    ...
    return (
      ...
      >
        <NativeView style={{ zIndex: 100000 }}>
