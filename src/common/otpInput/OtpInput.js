...
import { convertNumbers2English } from '../utils/numbers';
          ...
          style={
            selectedIndex === index
              ...
              : index<selectedIndex || selectedIndex<0
                ? [defaultTextFieldStyle, codeInputFieldStyleAfterAdd,{color:'black'}]
                
                : [defaultTextFieldStyle, codeInputFieldStyle,{color:'black'}]
          }
          ref={ref => {
            this.fields[index] = ref;
          }}
          onChangeText={text => { 
            let newText=convertNumbers2English(text)
            this.onChangeText(index, newText);
          }}
...
export default connect(mapStateToProps)(OTPInputView);
